...
public class ImportExportJsonHelperTest {
    ...
    public void testEmptySource() throws Exception {
        ...
        List<SubscriptionItem> items = ImportExportJsonHelper.readFrom(new ByteArrayInputStream(emptySource.getBytes(StandardCharsets.UTF_8)), null);
    ...
    private List<SubscriptionItem> readFromWriteTo(String jsonOut) throws Exception {
        final ByteArrayInputStream inputStream = new ByteArrayInputStream(jsonOut.getBytes(StandardCharsets.UTF_8));
